...
// ===========================
// Candidate OTP
Route::get('/verify-otp/{email}', [CandidateController::class, 'showOtpForm'])->name('verify.otp');
Route::post('/verify-otp/{email}/submit', [CandidateController::class, 'submitOtp'])->name('verify.otp.submit');
Route::get('/resend-otp/{email}', [CandidateController::class, 'resendOtp'])->name('resend.otp');

// Employer OTP
Route::post('/verify-otp/{email}/submit', [EmployerController::class, 'submitOtp'])->name('verify.otp.submit');
Route::get('/resend-otp/{email}', [EmployerController::class, 'resendOtp'])->name('resend.otp');
