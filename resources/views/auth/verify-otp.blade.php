        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-md-12">
                    ...
                    <h2 class="ipt-title text-light">Email Verification</h2>
                    <span class="text-light opacity-75">Verify your email using the 6 digit code sent to your
                        email</span>
                    ...
                    <div class="vesh-detail-bloc">
                        <div class="vesh-detail-bloc-body pt-3">
                            <ul class="nav nav-pills mb-3 justify-content-center" id="pills-tab" role="tablist">
                                <li class="nav-item">
                                    <div></div>
                                    <div class="nav-link active" id="signin-tab" data-bs-toggle="pill"
                                        data-bs-target="#signin" type="" role="tab" aria-controls="signin"
                                        aria-selected="true">Verify Email</div>
                                </li>
                                            ...
                                            <form method="POST"
                                                ...
                                                <div class="form-group">
                                                    <a href="{{ route('resend.otp', ['email' => $email]) }}"
                                                        class="m-l5 btn btn-secondary" id="resendBtn">
                                                        <i class="fas fa-unlock-alt"></i> Resend code
                                                    </a>
                                                    </button>

                                                    <span id="countdown" class="d-block mt-2 text-danger"></span>
