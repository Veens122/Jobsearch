        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-md-12">
                    ...
                    <h2 class="ipt-title text-light">Password Reset</h2>
                    <span class="text-light opacity-75">Reset your password using the 6 digit code sent to your
                        email</span>
                    ...
                    <div class="vesh-detail-bloc">
                        <div class="vesh-detail-bloc-body pt-3">
                            ...
                            <ul class="nav nav-pills mb-3 justify-content-center" id="pills-tab" role="tablist">
                                <li class="nav-item">
                                    <span class="nav-link active">Password Reset</span>
                                </li>
                            </ul>

                            <div class="tab-content">
                                <div class="tab-pane fade show active" id="signin" role="tabpanel" tabindex="0">
                                            ...
                                            <form method="POST" action="{{ route('submitPasswordResetCode') }}">
                                                ...
                                                <div class="form-group text-center">
                                                    <button type="button" class="btn btn-secondary" id="resendBtn"
                                                        onclick="location.href='{{ route('resend.otp', ['email' => $email]) }}'"
                                                        disabled>
