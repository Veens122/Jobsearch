...
<body class="green-theme">
    ...
    <!-- Header -->
    @include('snippets.candidate_header')
    <!-- Header End -->

    @include('snippets.candidate_side_bar')

    @yield('content')

    @include('snippets.candidate_footer')
    <!-- Footer -->
        ...
        <div>
            <ul id="themecolors" class="m-t-20">
                <li><a href="{{ asset('assets/javascript:void(0) ') }}" data-skin="green-theme" class="green-theme">
                        1</a></li>
                <li><a href="{{ asset('assets/javascript:void(0)') }}" data-skin="red-theme" class="red-theme">2</a>
                </li>
                <li><a href="{{ asset('assets/javascript:void(0)') }}" data-skin="blue-theme" class="blue-theme">3</a>
                </li>
                <li><a href="{{ asset('assets/javascript:void(0)') }}" data-skin="yellow-theme"
                        class="yellow-theme">4</a></li>
                <li><a href="{{ asset('assets/javascript:void(0)') }}" data-skin="purple-theme"
                        class="purple-theme">5</a></li>
                <li><a href="{{ asset('assets/javascript:void(0)') }}" data-skin="orange-theme"
                        class="orange-theme">6</a></li>
                <li><a href="{{ asset('assets/javascript:void(0)') }}" data-skin="brown-theme" class="brown-theme">7</a>
                </li>
                <li><a href="{{ asset('assets/javascript:void(0)') }}" data-skin="cadmium-theme"
                        class="cadmium-theme">8</a></li>
