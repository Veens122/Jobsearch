             ...
             <div class="dashboard-inner">
                 <ul data-submenu-title="Main Navigation">
                     <li class="active"><a href="{{ route('candidate.dashboard') }}"><i
                             ...
                             Dashboard</a></li>
                     <li><a href="{{ route('profile.candidate-profile') }}"><i class="fa-regular fa-user me-2"></i>User
                             Profile </a>
                     </li>
                     ...
                     <li><a href="employer-submit-job.html"><i class="fa-solid fa-pen-ruler me-2"></i>Submit
                             Jobs</a></li>
                     <li><a href="employer-applicants-jobs.html"><i class="fa-solid fa-user-group me-2"></i>Applicants
                             Jobs</a></li>
                    ...
                    <div class="jbs-grid-usrs-caption mb-3">
                        ...
                        <div class="jbs-tiosk">
                            <h4 class="jbs-tiosk-title"><a
                                    href="">{{ $candidate->candidateProfile->job_title ?? 'N/A' }}</a></h4>
                            <div class="jbs-tiosk-subtitle"><span><i
                                        class="fa-solid fa-location-dot me-2"></i>{{ $candidate->candidateProfile->city ?? 'Unknown Location' }}</span>
                            </div>
                        </div>
                    </div>
                </div>
